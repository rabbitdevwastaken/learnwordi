      ...
      <section className="w-full py-6 sm:py-12 md:py-24 lg:py-32 xl:py-48">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_600px] lg:gap-12 xl:grid-cols-[1fr_800px]">
            <div className="flex items-center justify-center sm:w-full lg:order-last">
              <div className="mockup-browser inline-block border bg-base-300">
                <div className="mockup-browser-toolbar">
                  <div className="input">https://mark42.com</div>
                </div>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Meet Mark42: The AI tool for crafting perfect tweets.
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Create engaging content with the power of AI. Mark42 analyzes
                  your message and suggests the best words to capture attention.
                </p>
              </div>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
          ...
          <div className="mx-auto w-full max-w-sm space-y-2">
            <form className="flex space-x-2">
              <input
                className="input max-w-lg flex-1"
